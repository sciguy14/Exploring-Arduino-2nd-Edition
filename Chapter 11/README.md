_Exploring Arduino:_ Second Edition, Chapter 11
===============================================
The code in this folder is for [Chapter 11 of the SECOND EDITION of _Exploring Arduino_](https://www.exploringarduino.com/content2/ch11)

| Listing  | Sketch/Code Description                | Folder Name  |
| -------- | -------------------------------------- | ------------ |
| 11-1     | Accelerometer-based orientation sensor | /orientation |
| 11-2     | Accelerometer-based instrument         | /instrument  |
